...
<div className="text-center mb-16 animate-on-scroll relative">
{/* Background decoration */}
<div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-gradient-to-br from-yellow-100/30 to-orange-100/30 rounded-full blur-3xl -z-10"></div>

{/* Badge */}
<div className="inline-block mb-6">
<span className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-yellow-100 to-orange-100 rounded-full text-sm font-bold text-orange-700 border-2 border-orange-300 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
...
<span className="bg-gradient-to-r from-yellow-600 via-orange-600 to-yellow-700 bg-clip-text text-transparent animate-gradient" style={{
...
{/* Animated underline */}
<div className="absolute -bottom-3 left-0 right-0 h-1.5 bg-gradient-to-r from-transparent via-orange-500 to-transparent rounded-full opacity-60"></div>
<div className="absolute -bottom-3 left-1/4 right-1/4 h-1.5 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full shadow-lg"></div>
</span>
</h2>

{/* Subtitle */}
<p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium">
نقدم مجموعة <span className="text-orange-600 font-bold">شاملة</span> من خدمات الدفع الإلكتروني وشحن الألعاب والمنصات الرقمية
</p>
